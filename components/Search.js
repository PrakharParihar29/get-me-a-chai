    ...
    <>
      <div className="relative inline-block">
        ...
        <button
          ...
          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs md:text-sm px-3 py-1.5 md:px-5 md:py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          type="button"
          onClick={() => setShow(!show)}
        >
          <svg
            className="size-4 md:size-5 font-bold"
            aria-hidden="true"
